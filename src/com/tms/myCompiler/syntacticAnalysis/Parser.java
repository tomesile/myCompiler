...
public class Parser {
    ...
    protected static class Repeat extends Element {
            ...
            throws ParseException
        {
            while (parser.match(lexer)) {
                ...
                if (t.getClass() != AstBranch.class || t.numChildren() > 0)
                    res.add(t);
                if (onlyOnce)
                    break;
            }
    ...
    protected static class Expr extends Element {
        ...
        protected Expr(Class<? extends AstTree> clazz, Parser exp,
                       Operators map)
        {
    ...
    protected static abstract class Factory {
        ...
        protected static Factory getForASTList(Class<? extends AstTree> clazz) {
                ...
                f = new Factory() {
                    protected AstTree make0(Object arg) throws Exception {
                        ...
                        if (results.size() == 1)
                            ...
                            return new AstBranch(results);
                    }
                };
            return f;
        }
        protected static Factory get(Class<? extends AstTree> clazz,
                                     Class<?> argType)
        {
            if (clazz == null)
                return null;
            ...
            try {
                final Constructor<? extends AstTree> c
